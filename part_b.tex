...
It can give out a single, boneshaking hoot that causes d6 Damage to everyone nearby. Anyone reduced to 0hp by this hoot is not at risk of a Critical Damage but must pass a \save{STR} or be stunned.
...
\statpar{Manticore}
STR~17, DEX~15, Armour~1, 8hp, 2d6 Claws, d8 Bite.
...
\statpar{Mummy}
STR~16, DEX~8, WIL~12, Armour~1, d8~Fist, immune to non-magical attacks, Fire attacks are Enhanced.

Anyone attacked by a Mummy must succeed on a \save{WIL} or be stunned on the next turn.
...
\statpar{Ogre}
STR~18, DEX~8, WIL~7, Armour~1, 6hp, club (d8).
...
\statpar{Red Dragon}
STR~20, WIL~12, 25hp, Armour~3, d10~Claws, Advantage on Saves from magic.
...
\statpar{Skeleton}
DEX~13, WIL~12, Armour~2 (only against piercing attacks such as arrows and spears), 5hp, blunt sword (d6).
...
\subparagraph{Grapple:} pass a \save{DEX} or be grappled, immobilized, and take d8~Damage now and on each subsequent turn until a successful \save{STR or DEX}.

\subparagraph{Frightening Gaze:} when Yeti presents itself and gazes upon its opponents, everyone must succeed on a \save{WIL} or be stunned on the next turn.
...
\statpar{Bear}
STR~15, WIL~7, Armour~1, 6hp, 2d6~Claws, d8~Bite.

\statpar{Crocodile}
STR~15, WIL~5, Armour~1, d8~Bite.

\statpar{Deer}
DEX~16, WIL~5, 2hp, d6~Hooves.

\statpar{Elephant}
STR~20, WIL~8, Armour~1, 12hp, 2d8~Tusks.
...
\statpar{Lion}
STR~17, DEX~15, Armour~1, 6hp, 2d6~Claws, d8~Bite.
...
\subparagraph{Constrict:} pass a \save{DEX} or be grappled, immobilized, and take d8~Damage now and on each subsequent turn until a successful \save{STR or DEX}.
