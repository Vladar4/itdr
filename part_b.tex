...
\statpar{Brain Lord}
STR~14, DEX~14, WIL~20, 18hp, \mbox{immune} to mind-altering Spells.
...
\statpar{Ghoul}
STR 13, DEX 15, WIL 6, 5hp, 2d6 Claws, d8 Bite, \mbox{immune} to mind-altering Spells.
...
\statpar{Mummy}
STR~16, DEX~8, 9hp, Armour~1, d8~Fist, \mbox{immune} to non-magical attacks and mind-altering Spells, Fire attacks are Enhanced.
...
\statpar{Skeleton}
DEX~13, WIL~12, 5hp, Armour~2 (only against piercing attacks such as arrows and spears), blunt sword (d6), \mbox{immune} to mind-altering Spells.
