...
\statpar{Leech Swarm}
DEX~14, WIL~6, 9hp, d6~Bite, all weapon attacks are Impaired.

\subparagraph{Leech:} if the bite reduces STR score, the swarm restores the same amount of STR.
...
\statpar{Shark}
STR~14, DEX~14, WIL~5, 4hp, Armour~1, d8~Bite.
