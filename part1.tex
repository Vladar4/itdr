...
Gain Advantage on Saves related to a certain field of expertise: animal handling, athletics, burgling, cheating, drinking, negotiation, quickness, stealth, etc. While you are not under pressure you don't need to make such Save at all.
...
\equip{Adventuring Gear}{5p each}: 10ft Rope, Caltrops (slows pursuers), Chalk, Dice, Flint and Steel, Food Ration, Parchment, Spike, Tent, Bunch of Torches.
...
\equip{Fancy Items}{10s each}: Board Game, Elaborate Clothes, Lantern, Mirror, Sand Timer, Spyglass.
