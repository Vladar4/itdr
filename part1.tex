...
\begin{enumerate}
	...
	\item \textbf{Harmony:} Until your next Rest, \textbf{P} animals become friendly unless attacked, and you can talk to them. Repeating will end the current effect.
	\item \textbf{Omen:} Up to \textbf{P} times before your next Rest, foresee the immediate outcome of your actions (good, bad, both, or unclear).
	\item \textbf{Smite:} Your attack deals at least \textbf{P} Damage \mbox{ignoring} Armour and supernatural resistances.
...
All characters carry \textbf{standard equipment}, including simple clothes, a backpack, basic camping equipment, five torches, and three days' rations.
...
\index{Light}
\equip{Adventuring Gear}{5p each} 10-ft Rope, Caltrops (slows pursuers), Chalk, Dice, Flint and Steel, Food Ration, Lamp Oil, Parchment, Spike, Tent, 5 Torches.

\equip{Tools}{1s each} Animal Trap, Collapsible 10-ft Pole, Crowbar, Drill, Fishing Pole, Grappling Hook, Hatchet, Lockpicks, Pickaxe, Shovel, Writing Set.
...
\index{Mule}
\index{Horse}
\subparagraph{Mounts:} Donkey (20s) (STR~12, WIL~5, 2hp),\\
Mule (50s) (STR~14, WIL~5, 3hp),\\
Horse~(1g) (STR~16, DEX~12, WIL~5, 3hp).
...
\index{Property}
\index{Structures}
\subparagraph{Property:} Shack (1g), Room (5g), Cottage (10g), Workshop (20g), House (100g), Manor (500g).
...
\begin{itemize}
	...
	\item Specialist (10s): dagger (d6), area of expertise.
