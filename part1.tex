...
\feat{Healer}
Restore d6 Ability Score Loss to an ally overnight, spending 10s worth of healing supplies.
...
\weapon{Martial Melee Weapon}{10s}{d6/d8} Basic, purpose-made weapons. Axe, dagger, mace, spear, sword, etc.
...
\weapon{Simple Ranged Weapon}{1s}{d4} Tools or weapons not built for frequent use in battle. Hunting bow, sling, throwing daggers, etc.
...
\equip{Shield}{5s}: +1 Armour, has no effect when used with Full Armour.
...
\equip{Adventuring Gear}{5p each}: 10ft Rope, Spike, Bunch of Torches, Chalk, Parchment, Flint and Steel, Tent, Dice, Caltrops (slows pursuers).

\equip{Tools}{1s each}: Crowbar, Hatchet, Animal Trap, Lockpicks, Writing Set, Fishing Pole, Shovel, Grappling Hook, Pickaxe, Collapsible Pole.

\equip{Fancy Items}{10s each}: Mirror, Lantern, Spyglass, Sand Timer, Board Game, Elaborate Clothes.
