...
\paragraph{Drawbacks}
Most powerful magic items usually have some kind of a drawback or a detriment to its user, either \mbox{permanent} or occurring each time the item is used.
...
\begin{dbox}
	See \textbf{\nameref{subsec:random_magic_items}} in \textbf{\customref{ch:appendix_a}{Appendix A}} for \mbox{additional inspiration}.
\end{dbox}
