...
\chapterx{Appendix A: Class-ic Edition}
\index{Classes}
...
See \textbf{Chapter 4} for additional information.
...
\subparagraph{Advancement}: When you pass your \save{WIL} (granted by your Iron Rod) against a \nth{1}~(Proven), \nth{2}~(Veteran), or \nth{3}~(Master) Circle Spell, reflect it on the caster.
...
\subparagraph{Raging Ritual}: Until the end of combat you have advantage on \saves{STR} and can attack two targets per turn. This effect ends if you haven't attacked or taken Damage since your last turn.
