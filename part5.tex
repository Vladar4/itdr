...
\index{Risk}
Generally, the Referee should inform the players if they are taking a risk. A game should have surprises, but players should feel that their decisions have led to the risk that result in nasty surprises.\looseness=-1
...
\index{Damage}
\index{Damage!bonus}
\index{Raising/Lowering Damage dice}
\index{Lowering Damage dice|see {Raising/Lowering Damage dice}}
