...
\vfill
\paragraph{Grapple}
If a target fails a \save{DEX}, it is Restrained until a successful \save{STR or DEX} on the following turns. Monsters cannot attack with limbs they are currently using for grapple, but strong ones might damage the grappled target instead.
