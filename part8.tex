...
\vfill
\subsection*{\nth{3} and 3.\nth{5} Editions}
\subparagraph{HP:} 1hp per HD. +1hp for Small or Medium creatures; +2hp for Large or bigger ones, except Oozes.
...
\subparagraph{Morale:} keep using 2d6 (Original and Basic), 2d10~(Advanced), or convert it to d20 (\save{WIL}):
