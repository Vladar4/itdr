...
\paragraph{Grapple}
If target fails a \save{DEX} it is immobilized until a successful \save{STR or DEX} on following turns. Monsters cannot attack with limbs they currently use for grapple, but strong ones might Damage the grappled target instead.
