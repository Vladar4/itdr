...
\begin{dtable}[cL|cL]
	\textbf{d14*} & \textbf{Feature} & \textbf{d14} & \textbf{Feature} \\
	1 & Assassin	& 8 & Mystic \\
	2 & Beastmaster	& 9	& Sharpshooter \\
	3 & Berserker	& 10& Skilled \\
	4 & Brawler		& 11& Swashbuckler \\
	5 & Commander	& 12& Tactician \\
	6 & Duellist	& 13& Thaumaturge \\
	7 & Healer		& 14& Warrior \\
\end{dtable}
{\em* Roll d20 ignoring rolls over 14.}
...
\subparagraph{Mystic} rolls for random Cantrips (d20) and \nth{1} Circle Spells (\textbf{Random 36 Spells} table from \textbf{\fullref{ch:magic}}, page \pageref{random_spells}). Chose one of these spells as a Signature Spell or roll a d6 for a random one.

\subparagraph{Thaumaturge} rolls for a random Gift.
