...
\subparagraph{Mystic} rolls for random Cantrips (d20) and \nth{1} Circle Spells (\textbf{Random 36 Spells} table from \textbf{Chapter~4: Magic}, p.12). Chose one of these spells as a Signature Spell or roll a d6 for a random one.
