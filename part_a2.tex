...
\subparagraph{Mistico:} tira per stabilire a caso Trucchetti (d20) e Incantesimi del 1° Cerchio (\textbf{tabella dei 36 Incantesimi Random} dal \textbf{\fullref{ch:magia}}\safepageref{, pagina }{incantesimi_random}{}). Scegli uno di questi Incantesimi con Incantesimo Distintivo o tira un d6 per stabilirne uno a caso.
