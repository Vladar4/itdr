...
\subparagraph{Ezekiel:} I'll boost Toku's attack with my Guided Strike cantrip.

\subparagraph{Referee:} Okay, roll for damage.

\subparagraph{Toku:} {\em (Rolls 3d6 (two daggers + Guided Strike bonus weapon die), taking the highest result)} That's a 5!
...
\subparagraph{Toku:} Running past it and trying to scare it seems needlessly risky when we have a perfectly good exit right here!
