...
\subparagraph{Arbitro:} {\em (sottrae 7 (6 + 1 per l'attaccante in più) danni e prende nota che l'opponente è ora a 0pf, con 3 Danno residui)} la spingi indietro con un calcio, facendole perdere l'equilibrio e tagliandole un fianco. {\em (tira un \save{FOR} vs Danno Critico, che riesce)} La copia ruggisce emettendo un rumore da disturbo elettrico, ma è ancora in piedi.
