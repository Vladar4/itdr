...
\subparagraph{Toku:} {\em (Rolls 2d6 (two daggers) + d12 (enhanced attack), taking the highest result)} That's a 6!

\subparagraph{Uthred:} {\em (Rolls d8 (weapon damage) + d4 (bonus die), taking the highest result)} That's 7 damage!

\subparagraph{Referee:} {\em (Subtracts 7 damage and notices that the opponent is now at 0hp, with 3 damage left over)} You kick the thing back, knocking it off balance and cutting through its side. {\em (Rolls a \save{STR} vs Critical Damage, succeeding)} The copy roars out in static fuzz but it's still standing.
...
\dimage{example1}{374pt}

\break

\dimage{example2}{542pt}
