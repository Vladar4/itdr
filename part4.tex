...
\begin{enumerate}
	...
	\item \spell{Caduta Piume} gli oggetti o le creature in una piccola sfera cadono lentamente.
	...
	\item \spell{Convoca Creatura} chiama una creatura extraplanare e non intelligente non più grande di un piccolo cane. Non ha vincoli di lealtà verso di te.
	...
	\item \spell{Destriero} convoca un cavallo da corsa. Sparisce dopo aver preso un qualsiasi Danno.
	\item \spell{Disco Fluttuante} crea un disco orizzontale del diametro di 3~piedi, che può reggere 100~libbre, che fluttua a 3~piedi dal suolo e si muove piano al tuo comando.
...
\break
	...
	\item \spell{Sopportare Elementi} chiunque si trovi \mbox{adiacente} a te può rimanere a suo agio in ambienti caldi o~freddi.
...
\begin{enumerate}
	...
	\item \spell{Assorda} assorda chiunque in un'area intermedia.
	...
	\item \spell{Illusione Minore} evoca un'immagine con suono.
	...
	\item \spell{Mano Spettrale} crea una mano incorporea luccicante per recapitare un tuo Incantesimo da contatto come azione in uno dei tuoi prossimi turni.
...
\break
	...
	\item \spell{Resistere a un Elemento} un tipo \mbox{specifico} di Danno elementale preso da una creatura è~Compromesso.
	...
	\item \spell{Scassinare} un urto rumoroso apre porte \mbox{e serrature.}
	...
	\item \spell{Vento Sussurrante} invia entro un miglio un breve messaggio a un gruppo o a un singolo bersaglio conosciuto.
...
\begin{enumerate}
	...
	\item \spell{Localizza Creatura} indica la direzione verso una creatura familiare.
