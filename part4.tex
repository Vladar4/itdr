...
\begin{dbox}
Optionally, this will result in a \textbf{Magic Mishap} as well (see \textbf{\nameref{sec:magic_mishaps}} in \textbf{\customref{ch:appendix_a}{Appendix A}}).
\end{dbox}
...
\begin{dbox}
	...
	See \textbf{\nameref{sec:manufacture_of_magic_equipment}} in \mbox{\textbf{\customref{ch:appendix_a}{Appendix A}}} for the additional information on creation of Focuses and Scrolls.
\end{dbox}
...
\begin{dbox}
	...
	Any character can activate a Scroll as an action. The spell is cast as Signature, destroying the Scroll. Succeed on a \save{WIL} or suffer a \textbf{Magic Mishap} (see \textbf{\nameref{sec:magic_mishaps}} in \textbf{\customref{ch:appendix_a}{Appendix A}}).
\end{dbox}
