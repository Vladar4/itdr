...
Casting a Prepared Spell causes \textbf{Spellburn} \mbox{Damage} equal to its Spell Circle~$\times$~2 \textbf{to the caster} ignoring Armour. At 0hp, Spellburn targets WIL \mbox{instead} of STR: pass a \save{WIL} to avoid Critical Spellburn or be Stunned for the next turn.
