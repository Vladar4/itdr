...
\index{Impairment|see {Attacks, impaired}}
...
\index{Enhancement|see {Attacks, enhanced}}
...
\subparagraph{Stunned} creatures cannot perform actions on their turn and have disadvantage on \saves{DEX}; attacks targeted at them are Enhanced.
