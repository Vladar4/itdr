...
When multiple attackers choose the same target, they roll together in a single attack, keeping the highest result, plus 1 point of Damage for each additional attacker, up to +5. Once the attack has been resolved, the target cannot be attacked again until their next turn.\looseness=-1
...
\index{Critical Damage|see {Damage, critical}}
On a failed \save{Critical Damage}, characters take Critical Damage and unable to take further action until they are tended to by an ally and have a Rest. If they are left untended to for an hour, they \textbf{die}.
