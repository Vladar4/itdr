...
Aside from speed penalty, heavy load reduces HP to 0. The same HP reduction happens when carrying more than three bulky items. Items are considered bulky if they require both hands to carry, for example, two-handed weapons, full armour, etc.
...
\begin{dtable}[cL]
	...
	5--7 & \textbf{Hallucinations.} By Referee discretion. \\
...
If you scavenge for the resource, roll a d6. If you roll over the Amount, increase it by one to a maximum of 5.
...
For example, a small wooden ship will have \mbox{Armour~5} (wood of medium thickness) and 8 HP.
