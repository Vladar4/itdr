...
The daily travel is divided into \textbf{24} time segments (TS), 20 minutes each.
...
\index{Forced March}
Lacking \textbf{up to 5~TS} to finish the leg, you can complete it regardless. Lacking more, you can perform a \textbf{Forced March:} every \textbf{2 extra hours} of travel adds \textbf{6~TS}, but requires an Exhaustion Check right after.
...
\index{Rest}
\subparagraph{Rest} for a day every \textbf{5~days} of travel, or make an Exhaustion Check for every extra day of travel.% Each day of rest restores d4~STR lost to exhaustion.\tight

\tvspace

\textbf{Overload} (over 50~lb on foot or Cargo capacity) \textbf{doubles} the base travel cost (before any modifiers).
...
\tabcolsep=2.5pt
\begin{dtable}[Lccc]
	\textbf{Travel\hfill Terrain:} & \textbf{Clear} & \textbf{Rugged} & \textbf{Difficult} \\
	Road					& \textbf{5}	& \textbf{6} & \textbf{9} \\
	Off-road on foot		& \textbf{6}	& \textbf{8} & \textbf{12} \\
	Off-road mount/vehicle,
	except donkeys \& mules	& \textbf{7} & \textbf{10} & \textbf{15} \\
	\hline
...
\begin{itemize}
	\item \textbf{Horses:} $-$1~TS on any clear terrain;
	\item \textbf{Camels:} $-$2~TS off-road in a desert;
	\item \textbf{Elephants:} $-$3~TS off-road in a jungle.
\end{itemize}
...
\subparagraph{Major Hindrances:} concurrent activities (exploring, sneaking, foraging, etc.), exhaustion, extreme weather, large armies, wading across a river.\tight
...
\begin{dtable}[LcCl]
	...
	Donkey	& \sfrac{1}{10}~t (200~lb)	& 1	& 20s \\
	Mule	& \sfrac{1}{8}~t (250~lb)	& 1 & 20s \\
	Horse	& \sfrac{1}{5}~t (400~lb)	& 2 & 1g \\
	Camel	& \sfrac{1}{4}~t (500~lb)	& 2 & 1g \\
