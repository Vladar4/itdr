...
When creating the character or advancing to a new Experience Level, instead of choosing a new Feature, roll for a random one, including random Spells, \mbox{Expertise}, and Gifts (see page \pageref{random_features}), to gain one of the following benefits afterwards:
\begin{itemize}
