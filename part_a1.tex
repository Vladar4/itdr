...
Each time you \textbf{spend} a resource (or after combat for ammo), roll a d6. If you roll over the \textbf{Amount}, decrease it by one. On zero the resource is depleted.

If you \textbf{scavenge} for the resource, roll a d6. If you roll over the \textbf{Amount}, increase it by 1 (up to 5).

When \textbf{buying} resources to increase the \textbf{Amount} by 1 (up to 5), pay its price multiplied by your \mbox{current Amount~$\times$~d6.}
