...
% Fitting this TOC entry into a single line
\addtocontents{toc}{%
	\begingroup%
	\protect\fontsize{0.966\docFontSize}{\baselineskip}%
	\protect\selectfont}
\addcontentsline{toc}{chapter}{Appendix A: Additional and Alternative Rules}
\addtocontents{toc}{%
	\protect\fontsize{0.966\docFontSize}{\baselineskip}%
	\protect\selectfont%
	\endgroup}
...
\equip*{Squalid}{<1s/week}
Suffer d4 Ability Score Loss for a random Ability Score. Your reputation suffers.

\equip*{Modest}{1s/week}
Your reputation suffers.

\equip*{Adequate}{10s/week}
Restore d4 Ability Score Loss for a single Ability Score.

\equip*{Luxurious}{1g/week}
Heal one Ability Score Loss or a~non-magical ailment. Your reputation improves.

\begin{itemize}
	\item Add half as much for each pet you own.
	\item Halve all costs if you live in your own house.
\end{itemize}

Advancing to a new Experience Level usually takes \textbf{d4 weeks $\times$ new Level value} of downtime.
...
\begin{dtable}[rrRr]
	...
	\textbf{10}	&	\textbf{50}\halfsp	&	\textbf{100}	&	\textbf{200}	\\
	11	&	60\sfrac{1}{2}		&	121		&	242		\\
	12	&	72\halfsp			&	144		&	288		\\
	13	&	84\sfrac{1}{2}		&	169		&	338		\\
	14	&	98\halfsp			&	196		&	392		\\
	15	&	112\sfrac{1}{2}		&	225		&	450		\\
	16	&	128\halfsp			&	256		&	512		\\
	17	&	144\sfrac{1}{2}		&	289		&	578		\\
	18	&	162\halfsp			&	324		&	648		\\
	19	&	180\sfrac{1}{2}		&	361		&	722		\\
	20	&	200\halfsp			&	400		&	800		\\
\end{dtable}

1~lb equals 50g, 500s, or 500p in weight.
%1~lb equals 100 gold guilders, 1000 silver shillings, or 1000 copper pennies in weight.

\subsection{Overload}
\index{Overload}
Excess load or carrying \textbf{more than three} bulky items \textbf{halves the speed} and \textbf{reduces HP to 0}.

\index{Bulky Items|see {Items, bulky}}
\index{Items!bulky}
\subparagraph{Bulky Items} are those that require both hands to carry or are otherwise unwieldy, for example, two-handed weapons, a set of armour, a Mystic's Tome, a pot of black powder, wearing full armour without the Ironclad Feature, etc.
...
\subparagraph{Tome} is a collection of Scrolls bound together for convenience. Binding a new one costs 10s and takes a day. Attaching additional Scrolls to a Tome is free.
...
If you \textbf{scavenge} for a resource, roll a d6. If you roll \textbf{over} the \textbf{Amount}, increase it by one (up to 5). With expertise in this, roll twice, taking the higher result.
...
\vspace*{-0.5ex}
\begin{dtable}[lLrr]
	\multicolumn{2}{l}{~} & \multicolumn{2}{c}{\textbf{Base Cost, g}} \\
	\multicolumn{2}{l}{\textbf{Structure}} & \textbf{Wood} & \textbf{Stone} \\
	\multicolumn{2}{l}{Bridge, 100ft}					& 10	& 250 \\
	\multicolumn{2}{l}{Building, 1 floor, P=100~ft}		& 5 	& 50 \\
	\multicolumn{2}{l}{Gatehouse, P=200~ft}				& 10	& 100 \\
	\multicolumn{2}{l}{Keep, small, P=200~ft}			& 20	& 250 \\
	\multicolumn{2}{l}{Keep, big, P=400~ft}				& ---	& 1,000 \\
	\multicolumn{2}{l}{Tower, small, P=100~ft}			& 10	& 150 \\
	\multicolumn{2}{l}{Tower, big, P=200~ft}			& 20	& 300 \\
	\multicolumn{2}{l}{Wall, 100~ft}					& 10	& 100 \\
	\hline
	\multicolumn{2}{l}{Dungeon, 10~ft cube}				& 1 (earth) & 20 (rock) \\
	\multicolumn{2}{l}{Moat, 100~ft}					& 5 (earth) & 100 (rock) \\
	Road, 1~mile	& \multicolumn{3}{L}{10, 20, 50 on Clear, Rugged, \mbox{or Difficult terrain accordingly}} \\
\end{dtable}
{\em (P --- external perimeter of the building.)}

\subparagraph{Construction Crew} of four dozen people, led by a~master, builds 5g of the base cost weekly. Up to 5 crews can work on a single structure simultaneously, increasing the cost by half of the base per extra crew.

Additional factors can also impact speed and cost.
...
\newcommand{\tvspace}{\vspace{-0.25ex}}%\vspace{-0.38ex}}

\section{Travel}
\index{Travel}
Travel for \textbf{10~hours/day} before resting for the night.
The daily travel is divided into \textbf{20} time segments (TS), 30 minutes each.
TS cost of every \textbf{\travelunit{1}-mile} leg of the journey (or \travelunit{1}-mile hexagon) depends on the terrain and certain factors listed below.

\index{Forced March}
Lacking \textbf{1~TS} to finish the last leg, you can complete it regardless. Lacking more, you can perform a \textbf{Forced March:} every \textbf{2 extra hours} of travel adds \textbf{4~TS}, but requires an Exhaustion Check right after.

\tvspace

\index{Exhaustion}
\subparagraph{Exhaustion Check:} you or your mount must make a \save{STR} or lose \textbf{d4~STR} and stop for today, becoming \textbf{exhausted} (major hindrance) until a day of rest.\tight

\tvspace

\index{Rest}
\subparagraph{Rest} for a day every \textbf{5~days} of travel, or make an Exhaustion Check for every extra day of travel.
...
\begin{itemize}
	\item \textbf{Clear:} grassland, plains;
	\item \textbf{Rugged:} desert, hills, woodland;
	\item \textbf{Difficult:} forest, mountains, swamp.
\end{itemize}
%\end{minipage}
...
\bgroup
\tabcolsep=4.5pt%2.5pt
\begin{dtable}[cLccc]
	\multicolumn{2}{l}{\textbf{Travel\hfill Terrain:}}
	& \textbf{Clear} & \textbf{Rugged} & \textbf{Difficult} \\
	\multicolumn{2}{l}{On foot}			& \textbf{5} & \textbf{6} & \textbf{8} \\
	\multicolumn{2}{l}{Donkey or mule}	& \textbf{5} & \textbf{6} & \textbf{7} \\
	\multicolumn{2}{l}{Horse}			& \textbf{4} & \textbf{6} & \textbf{9} \\
	\multicolumn{2}{l}{Camel\note[1]}	& \textbf{4} & \textbf{6} & \textbf{12} \\
	\multicolumn{2}{l}{Elephant\note[2]}& \textbf{8} & \textbf{9} & \textbf{12} \\
	\multicolumn{2}{l}{Vehicles}		& \textbf{6} & \textbf{9} & \textbf{12} \\
	\hline
	\cellcolor{dColor1}	& Road			& $-$1	& $-$2	& $-$3 \\
					& Minor hindrance	& +1	& +2	& +3 \\
	\multirow{-3}{*}{\cellcolor{dColor1}\rotatebox{90}{\textbf{Mod.}}}
...
\begin{itemize}
	\item[{\note[1]}] \textbf{Camel:} $-$2~TS off-road in a~desert;
	\item[{\note[2]}] \textbf{Elephant:} $-$3~TS off-road in a~forest.
\end{itemize}

\tvspace

%\textbf{Clear:} grassland, plains; \textbf{Rugged:} desert, forest, hills; \textbf{Difficult:} jungle, mountains, swamp.

\tvspace

\subparagraph{Minor Hindrances:} fording a river, harsh weather, large groups (caravan, army unit, etc.).

\tvspace

\subparagraph{Major Hindrances:} concurrent activities (exploring, sneaking, foraging, etc.), exhaustion, extreme weather, overload, wading across a river.

%\tvspace
\vfill

\subparagraph{Passengers} take 250~lb of cargo space. Cargo and Riders/Passengers values are mutually exclusive.\tight
...
\begin{dtable}[Lcrcl]
	...
	Cart	& 1	& 1000~lb	& 4	& 30s \\
	Carriage& 2	& 2000~lb	& 8	& 60s \\
	Wagon	& 4	& 4000~lb	& 16& 1g \\
\end{dtable}

\break

\subparagraph{Going Astray} is possible when traversing obscured or unfamiliar terrain, in dense fog or heavy rain, etc. If you have some advantage in navigation, roll a \textbf{d8}; otherwise, roll a \textbf{d6} for every such \travelunit{1}-mile leg/hex:

\begin{dtable}[cL]
	\textbf{Roll} & \textbf{Outcome} \\
	1	& Veer off up to 120\textdegree (1--2 hexes left or right). \\
	2	& Veer off up to 60\textdegree (1 hex left or right). \\
	3	& Double the travel cost for this leg/hex. \\
	\hspace*{\widthof{+}}4+	& On course. \\
\end{dtable}

\subparagraph{Horizon} is 3 miles away at sea level, 6 miles at 25~ft (roof, hill), and over 12 miles at 100~ft (ship's mast, treetop, tower). The landscape can obstruct the view. Tall objects can be seen behind the horizon.
...
\index{Longship}
\index{Galley}
\begin{dtable}[l>{\centering\arraybackslash}p{2.2em}>{\centering\arraybackslash}p{2.2em}C>{\centering\arraybackslash}p{2.2em}L]
\textbf{Vehicle} & \textbf{Miles} & \textbf{Hexes} & \textbf{Crew} & \textbf{Cargo} & \textbf{Cost} \\
...
To decide for how many hours or days the current weather persists, choose an appropriate die from d4 to d12, depending on the climate and weather type.
...
\subparagraph{Holding Breath} is possible for STR/3 turns (round up), $\times$2 for trained divers. Turns spent on swimming or other activities count for two. Take d6~Damage ignoring Armour for each extra turn not breathing.
...
Flying creatures travel for \textbf{8~hours/day} before resting for the night. Flying magic items have the energy to function for the same daily amount of time.

\index{Mounts}
\begin{dtable}[llCCC]
	\textbf{Mount} & \textbf{Example} & \textbf{Miles} & \textbf{Hexes} & \textbf{Riders} \\
	Small				& pixie		& \travelunit{6}  & 6  &---\\
	Medium 				& harpy		& \travelunit{6}  & 6  & 1 \\
	Large				& griffon	& \travelunit{12} & 12 & 2 \\
	Large, fast			& pegasus	& \travelunit{18} & 18 & 2 \\
	Huge				& dragon	& \travelunit{12} & 12 & 8 \\
	Magic device		& broom		& \travelunit{12} & 12 & 2 \\
	Magic vehicle		& carpet	& \travelunit{6}  & 6  & 8 \\
\end{dtable}
...
\subparagraph{Aerial Vehicles} travel for \textbf{12~hours/day}. Double crew allows to continue travelling at night.

\textbf{Airships} use the \textbf{Wind Force} rule, while \textbf{balloons} always follow the wind. Every 2 hours you may change altitude, rolling for a new wind direction.

\index{Balloon}
\index{Airship}
\begin{dtable}[lccccl]
	\textbf{Vehicle} & \textbf{Miles} & \textbf{Hexes} & \textbf{Crew} & \textbf{Cargo} & \textbf{Cost} \\
	Balloon	& \travelunit{6} & 6 & 1 & 1~t & 25g \\
	Airship	& \travelunit{6} & 6 & 10& 10~t& 200g \\
\end{dtable}
...
\index{Exploration}
\index{Turns}
Each \textbf{combat turn (half-minute)}, characters can move up to \textbf{\basemove~feet}, adjusted for the following:
\vspace{-0.2ex}
\begin{itemize}
	\item \textbf{$\pm$10~feet} for clear or difficult terrain;
	\item \textbf{$\pm$10~feet} for each point of cost modifiers;
	\item \textbf{$\times$2} when forgoing any actions this turn;
	\item \textbf{$\times$\sfrac{1}{2}} when overloaded, cannot jump.
\end{itemize}

\textbf{Jumping} over \sfrac{1}{2} of the base move (over \sfrac{1}{4} from a standing position) requires a \save{STR}. Jump distance is subtracted from this turn's move.
...
\begin{dtable}[cL]
	...
	\textbf{Volume} & \parbox{\linewidth}{%
			...
			\textbf{1 pint} is 16 ounces and weighs 1 pound} \\
	\midrule
	\rowcolor{dColor2}
	\textbf{Weight} & \parbox{\linewidth}{%
			\textbf{1 ton} is 2000 pounds\\
			\textbf{1 pound} is 16 ounces\\
			\mbox{\textbf{1 pound} is} 50 gold guilders,\\ 500 silver shillings or copper pennies} \\
\end{dtable}
\egroup
