...
\index{Rest}
\subparagraph{Rest} for a day every \textbf{5 days} of travel, or make an Exhaustion Check for every extra day of travel. Each day of rest restores d4~STR Loss from exhaustion.\tight

\tvspace

\textbf{Overload} (over 50~lb on foot or Cargo capacity) \textbf{doubles} the travel cost.
...
\begin{dtable}[l>{\centering\arraybackslash}p{3em}CC]
\textbf{Terrain} & \textbf{Clear} & \textbf{Rugged} & \textbf{Difficult} \\
Off-road (on foot)	& \textbf{6}	& \textbf{8} & \textbf{12} \\
Road (on foot)		& \textbf{5}	& \textbf{6} & \textbf{9} \\
\hline
%\multicolumn{4}{l}{\textbf{Modifiers:}} \\
%Road	& $-$1 & $-$2 & $-$3 \\
Minor hindrance	& +1 & +2 & +3 \\
Major hindrance	& +2 & +4 & +6 \\
%\multicolumn{4}{l}{\textbf{Transport:}} \\
\hline
Donkeys, mules	& +0	& +0	& +0 \\
Horses			& $-$1	& +2	& +3 \\
Camels			& +0	& +2 or $-$2 \mbox{in desert}	& +3 \\
Elephants		& +0	& +2	& +3 or $-$3 \mbox{in jungle} \\
Vehicles		& +0	& +2	& +6 \\
\end{dtable}
