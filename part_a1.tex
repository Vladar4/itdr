...
\subparagraph{Minor Hindrances:} fording a river, harsh weather, large groups (caravans, army units, etc.).

\tvspace

\subparagraph{Major Hindrances:} concurrent activities (exploring, sneaking, foraging, etc.), exhaustion, extreme weather, wading across a river.\tight
