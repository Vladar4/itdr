...
\textbf{Jumping} over \sfrac{1}{2} of the base move distance (over \sfrac{1}{4} from a standing position) requires a \save{STR}. Jumps count as a part of the movement.
