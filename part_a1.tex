...
\subparagraph{Scroll}: 20s $\times$ Circle in resources, d4 days $\times$ Circle. Successful on X-in-6, \mbox{X = 1 + Mystic Level -- Circle}, resources are lost either way. (Designing a new spell, if the Referee allows it, costs and takes at least $\times$10 as much time and requires some rare ingredients.)
...
For time-tracking purposes, \textbf{exploration turns} take \textbf{10 minutes}: casting spells outside of combat, searching, lockpicking, resting, etc.
