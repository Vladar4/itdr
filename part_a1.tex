...
\index{Encumbrance}
Aside from speed penalty, a heavy load \textbf{reduces HP to 0}. The same HP reduction happens when carrying \textbf{more than three} bulky items. Items are considered bulky if they require both hands to carry or are otherwise unwieldy, for example, two-handed weapons, armour, a Mystic's Tome, a pot of black powder, etc.
