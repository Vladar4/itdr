...
\index{Exploration}
\index{Turns}
Each \textbf{combat turn (1 minute)} characters move their travel Grid value $\times$ 10 feet (generally \textbf{30 feet}; $\pm$10~feet for clear or difficult terrain; $\times$\sfrac{1}{2} when encumbered; $\times$2 when forgoing any actions this turn).
