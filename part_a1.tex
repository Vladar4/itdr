...
\index{Forced March}
Lacking \textbf{up to 5~TS} to finish the leg, you can complete it regardless. Lacking more, you can perform \textbf{Forced March:} every \textbf{2 extra hours} of travel adds \textbf{6~TS} but requires an Exhaustion Check.
...
\subparagraph{Holding Breath} is possible for STR/5 turns (round up). Turns spent on strenuous tasks count for two. Take d6~Damage ignoring Armour for each extra turn not breathing.
