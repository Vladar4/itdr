...
An ancient structure that floats at an unreachable height, following a daily route, passing pretty close to the local mountain range sometimes.
...
Flooded room with a tunnel at the bottom.

\paragraph{Unfinished Tunnel}
There are an undiscovered cave behind just a couple feet of rock. Sounds or some other signs might suggest its presence.
